...
set arma2srvpath=C:\Users\Administrator\Desktop\Overpoch
...
copy "%arma2srvpath%\%servername%\arma2oaserveroverpoch.RPT" "%arma2srvpath%\%servername%\RotatedLogs\%dtStamp%\arma2oaserver.RPT"
copy "%arma2srvpath%\%servername%\arma2oaserveroverpoch.mdmp" "%arma2srvpath%\%servername%\RotatedLogs\%dtStamp%\arma2oaserver.mdmp"
copy "%arma2srvpath%\%servername%\arma2oaserveroverpoch.bidmp" "%arma2srvpath%\%servername%\RotatedLogs\%dtStamp%\arma2oaserver.bidmp"
...
del /Q /F "%arma2srvpath%\%servername%\arma2oaserveroverpoch.RPT"
del /Q /F "%arma2srvpath%\%servername%\arma2oaserveroverpoch.mdmp"
del /Q /F "%arma2srvpath%\%servername%\arma2oaserveroverpoch.bidmp"
