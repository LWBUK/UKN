...
AN_fnc_formatWorldspace = {
	...
	_nil = [] ExecVM "\z\addons\dayz_server\missions\DayZ_Epoch_11.Chernarus\traderzones.sqf";
	_nil = [] ExecVM "\z\addons\dayz_server\missions\DayZ_Epoch_11.Chernarus\BalotaAF.sqf";
	_nil = [] ExecVM "\z\addons\dayz_server\missions\DayZ_Epoch_11.Chernarus\traderstary.sqf";
	_nil = [] ExecVM "\z\addons\dayz_server\missions\DayZ_Epoch_11.Chernarus\donorAF.sqf";
    _nil = [] ExecVM "\z\addons\dayz_server\missions\DayZ_Epoch_11.Chernarus\bsb_chernarus_plus_v2.sqf";
	_nil = [] ExecVM "\z\addons\dayz_server\missions\DayZ_Epoch_11.Chernarus\ChernoBuildings.sqf";
	_nil = [] ExecVM "\z\addons\dayz_server\missions\DayZ_Epoch_11.Chernarus\MilitaryAirport.sqf";
	_nil = [] ExecVM "\z\addons\dayz_server\missions\DayZ_Epoch_11.Chernarus\balota.sqf";
	_nil = [] ExecVM "\z\addons\dayz_server\missions\DayZ_Epoch_11.Chernarus\krasno.sqf";
	_nil = [] ExecVM "\z\addons\dayz_server\missions\DayZ_Epoch_11.Chernarus\basedichina.sqf";
	_nil = [] ExecVM "\z\addons\dayz_server\missions\DayZ_Epoch_11.Chernarus\basenovy.sqf";
	//_nil = [] ExecVM "\z\addons\dayz_server\missions\DayZ_Epoch_11.Chernarus\vybor.sqf";
	_nil = [] ExecVM "\z\addons\dayz_server\missions\DayZ_Epoch_11.Chernarus\nwaf.sqf";
	_nil = [] ExecVM "\z\addons\dayz_server\missions\DayZ_Epoch_11.Chernarus\valley.sqf";
	_nil = [] ExecVM "\z\addons\dayz_server\missions\DayZ_Epoch_11.Chernarus\krutoy.sqf";
	_nil = [] ExecVM "\z\addons\dayz_server\missions\DayZ_Epoch_11.Chernarus\pulkovo.sqf";
