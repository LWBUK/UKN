...
/*  NORMAL ADMIN HERE     */ _NAdmins = ["0"]; //do not have a , at the end.
...
/* ********************************************************************************* */
/*  Top esc menu TXT      */ _TopOfESC = "UKN"; //do not use " in this text.
/*  Bottom esc menu TXT   */ _LowerTop = "DayZ"; //do not use " in this text.
/*  Bottom esc menu TXT2  */ _LowerBottom = "OverPoch"; //do not use " in this text.
/*  Color esc menu TXT    */ _EscColor = [0.6,0,0,1];
/*  DebugMonitor TXT      */ _BottomDebug = "TS3: 78.31.67.100"; //do not use " in this text.
...
_ALLOWED_Dialogs = [-1,106,2200,6900,6901,6902,6903,420420,41144,711194,666,667,711197,55510,711195,41144,571113,9900,7777,7778,7779,2800,3800];
...
_ALLOWED_Dialogs = _ALLOWED_Dialogs + [20001,81000,88890,20001,20002,20003,20004,20005,20006,55510,55511,55514,55515,55516,55517,55518,55519,555120,118338,118339,711197,711195,76761,571113,50003,50004,8101]; // adding some others from community addons
...
_cMenu =
[
	"","#USER:_keyMenu","DoorManagement","Entercode","RscMainMenu","RscMoveHigh","#WATCH","#WATCH0",
	...
	"BTC_Hud","PlotManagement","MenClothing", "#USER:DamiSpawn"
];
...
[
	...
	"s_player3275_copyToKey","SP_refuel_action","SP_repair_action","SP_rearm_actions","s_player_setVectorsReset","s_player_setVectorsForward",
