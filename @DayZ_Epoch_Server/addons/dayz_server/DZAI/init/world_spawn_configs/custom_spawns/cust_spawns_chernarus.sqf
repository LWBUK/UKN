...
[
	...
	//Qdoba
	/*
	["Qdoba1",4,3,false] call DZAI_spawn_units;
    ["Qdoba2",2,2,false] call DZAI_spawn_units;	
    ["Qdoba3",4,3,false] call DZAI_spawn_units;	
    ["Qdoba4",2,2,false] call DZAI_spawn_units;	
    ["Qdoba5",4,3,false] call DZAI_spawn_units;	
    ["Qdoba6",2,2,false] call DZAI_spawn_units;	
    ["Qdoba7",4,3,false] call DZAI_spawn_units;	
    ["Qdoba8",2,2,false] call DZAI_spawn_units;	
    ["Qdoba9",4,3,false] call DZAI_spawn_units;
	["Qdoba10",2,3,false] call DZAI_spawn_units;
    ["Qdoba11",4,2,false] call DZAI_spawn_units;
    ["Qdoba12",2,3,false] call DZAI_spawn_units;	
    ["Qdoba13",4,2,false] call DZAI_spawn_units;	
    ["Qdoba14",2,3,false] call DZAI_spawn_units;	
    ["Qdoba15",4,2,false] call DZAI_spawn_units;	
    ["Qdoba16",2,3,false] call DZAI_spawn_units;	
    ["Qdoba17",2,2,false] call DZAI_spawn_units;	
    ["Qdoba18",4,3,false] call DZAI_spawn_units;
    ["Qdoba19",2,2,false] call DZAI_spawn_units;	
    ["Qdoba20",4,2,false] call DZAI_spawn_units;	
    ["Qdoba21",2,3,false] call DZAI_spawn_units;	
    ["Qdoba22",4,2,false] call DZAI_spawn_units;
    ["Qdoba23",2,3,false] call DZAI_spawn_units;	
    ["Qdoba24",4,2,false] call DZAI_spawn_units;	
    ["Qdoba25",2,3,false] call DZAI_spawn_units;	
    ["Qdoba26",4,2,false] call DZAI_spawn_units;	
*/