...
_baserunover23 = createVehicle ["MAP_t_salix2s", [(_position select 0) - 24, (_position select 1) - 0.01,-0.01],[], 0, "CAN_COLLIDE"];
	...
	//Troops
	[[(_position select 0) - 12, (_position select 1) - 15,0],2,"Medium",["Random","AT"],4,"Random","Hero","Random","Hero",_mission] call spawn_group;
	[[(_position select 0) + 12, (_position select 1) + 15,0],2,"Medium","Random",4,"Random","Hero","Random","Hero",_mission] call spawn_group;
