if(isServer) then {
	...
	[[(_position select 0) - 100, _position select 1, 0],[(_position select 0) + 100, (_position select 1) +100, 0],70,3,"HMMWV_Armored","Extreme","Hero","Hero",_mission] call vehicle_patrol;
	
	//Heli Para Drop
	[[(_position select 0),(_position select 1),0],[0,0,0],400,"BAF_Merlin_HC3_D",10,"extreme","Random",4,"Random","Hero","Random","Hero",true,_mission] spawn heli_para;
