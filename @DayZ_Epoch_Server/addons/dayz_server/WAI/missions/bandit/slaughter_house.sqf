...
_baserunover13 = createVehicle ["MAP_icebox",[(_position select 0) - 2, (_position select 1) - 0.01,-0.02],[], 0, "CAN_COLLIDE"];
	...
	//Troops
	[[(_position select 0) + 9, (_position select 1) - 13, 0],2,"Easy",["Random","AT"],4,"Random","Hero","Random","Hero",_mission] call spawn_group;
	[[(_position select 0) + 13, (_position select 1) + 15, 0],2,"Easy","Random",4,"Random","Hero","Random","Hero",_mission] call spawn_group;
	[[(_position select 0) - 23, (_position select 1) - 25, 0],2,"Easy","Random",4,"Random","Hero","Random","Hero",_mission] call spawn_group;
