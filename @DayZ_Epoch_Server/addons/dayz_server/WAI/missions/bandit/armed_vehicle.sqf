if(isServer) then {
	...
	[[_position select 0,_position select 1,0],_rndnum,"extreme",["Random","AT"],3,"Random","Hero","Random","Hero",_mission] call spawn_group;
	[[_position select 0,_position select 1,0],_rndnum,"extreme","Random",3,"Random","Hero","Random","Hero",_mission] call spawn_group;
	[[_position select 0,_position select 1,0],_rndnum,"extreme","Random",3,"Random","Hero","Random","Hero",_mission] call spawn_group;
