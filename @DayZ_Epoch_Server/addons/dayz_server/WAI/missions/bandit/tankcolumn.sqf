...
_baserunover13 = createVehicle ["Land_Fire_barrel_burning",[(_position select 0) - 9, (_position select 1) - 1,-0.02],[], 0, "CAN_COLLIDE"];
	...
	//Troops
	[[(_position select 0) - 7, (_position select 1) - 10, 0],2,"Hard",["Random","AT"],4,"Random","UN_CDF_Soldier_EP1","Random","Hero",_mission] call spawn_group;
	[[(_position select 0) + 16, (_position select 1) - 5, 0],2,"Hard","Random",4,"Random","UN_CDF_Soldier_Guard_EP1","Random","Hero",_mission] call spawn_group;
	[[(_position select 0) + 4, (_position select 1) + 18, 0],2,"Hard","Random",4,"Random","UN_CDF_Soldier_EP1","Random","Hero",_mission] call spawn_group;
