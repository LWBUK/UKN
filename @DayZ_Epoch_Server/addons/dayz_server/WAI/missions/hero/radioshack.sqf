...
_baserunover14 = createVehicle ["MAP_t_carpinus2s",[(_position select 0) + 28, (_position select 1) - 13,-0.02],[], 0, "CAN_COLLIDE"];
	...
	[[(_position select 0) - 4, (_position select 1) + 16, 0],2,"hard","random",4,"random","TK_Special_Forces_EP1","random","bandit",_mission] call spawn_group;
	[[(_position select 0) - 17, (_position select 1) - 4, 0],2,"random","random",4,"random","TK_Special_Forces_EP1","random","bandit",_mission] call spawn_group;
