if(isServer) then {
	...
	for "_i" from 0 to _rndgro do {
		[[_position select 0,_position select 1,0],_rndnum,"extreme",[1,"at"],4,"Random","Bandit","Random","Bandit",_mission] call spawn_group;
	};
	...
	if(_complete) then {
		[_crate,[8,ai_wep_all],8,1,2] call dynamic_crate;
	};
