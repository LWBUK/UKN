...
[[(_position select 0) + 13, (_position select 1) + 15, 0],2,"Hard","Random",4,"Random","Rocker1_DZ","Random","Bandit",_mission] call spawn_group;
[[(_position select 0) - 23, (_position select 1) - 25, 0],2,"Hard","Random",4,"Random","Rocker4_DZ","Random","Bandit",_mission] call spawn_group;
