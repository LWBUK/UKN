...
*/
private ["_missName","_coords","_base","_base1","_base2","_base3","_veh1","_veh2","_vehicle","_vehicle1","_crate","_crate2","_code"];
...
[[(_coords select 0) - 20, (_coords select 1) - 15,0],4,0,format ["DZMSUnitsMinor%1", _code]] call DZMSAISpawn;
sleep 3;
[[(_coords select 0) + 10, (_coords select 1) + 15,0],4,0,format ["DZMSUnitsMinor%1", _code]] call DZMSAISpawn;
sleep 3;
[[(_coords select 0) - 10, (_coords select 1) - 15,0],4,0,format ["DZMSUnitsMinor%1", _code]] call DZMSAISpawn;
sleep 3;
[[(_coords select 0) + 20, (_coords select 1) + 15,0],4,0,format ["DZMSUnitsMinor%1", _code]] call DZMSAISpawn;
