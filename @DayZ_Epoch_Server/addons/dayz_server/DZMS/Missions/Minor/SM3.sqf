...
*/
private ["_missName","_coords","_base","_base1","_veh1","_vehicle","_crate","_crate1","_code"];
...
[[(_coords select 0) - 4.0796, (_coords select 1) - 11.709,0],6,2,format ["DZMSUnitsMinor%1", _code]] call DZMSAISpawn;
sleep 3;
[[(_coords select 0) + 2.8872, (_coords select 1) + 18.964,0],6,2,format ["DZMSUnitsMinor%1", _code]] call DZMSAISpawn;
sleep 3;
