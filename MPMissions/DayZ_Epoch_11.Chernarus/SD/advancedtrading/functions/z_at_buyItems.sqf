...
if(_enoughMoney) then {
	...
	closeDialog 2;
		...
		//systemChat "You could not buy these items USE NORMAL TRADER TO BUY VEHICLES.";
		["<t size='1' shadow ='.6' color='#B22222'>You could not buy these items USE NORMAL TRADER TO BUY VEHICLES.</t>",0,(safezoneY + safezoneH * 0.43),30,1,0,32] spawn bis_fnc_dynamicText;
	};
}else{
	if( Z_SingleCurrency) then {
