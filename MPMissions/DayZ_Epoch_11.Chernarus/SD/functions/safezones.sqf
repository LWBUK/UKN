...
[
	...
	[[12060,12640,0],40,true],
	[[6772.35,2494.58,0],20,true],
...
[_infiSZ] spawn {
	...
	_startSafeZone =
	{
		...
		{
			_msg = 'You entered a Safe Zone! Vehicles and parts CAN be stolen: Beware!!';
			hint _msg;
	...
	_endSafeZone =
	{
		if (isNil 'inNow') then
		{
			...
			{
				_msg = 'You left the Safe Zone! Look out for Bandits and Thieves as you leave!!';
				hint _msg;
