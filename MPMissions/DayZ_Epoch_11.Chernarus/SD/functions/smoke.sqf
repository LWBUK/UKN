   [] spawn {
            //systemchat "Smokin weed, smokin wizz, Doin coke, drinkin beers, Drinkin beers, beers, beers, Rollin fattys, smokin blunts, Who smokes the blunts? We smoke the blunts. Rollin blunts and smokin";
			["<t size='1' shadow ='.6' color='#B22222'> Smokin weed, smokin wizz, Doin coke, drinkin beers, Drinkin beers, beers, beers, Rollin fattys, smokin blunts, Who smokes the blunts? We smoke the blunts. Rollin blunts and smokin</t>",0,(safezoneY + safezoneH * 0.43),30,1,0,32] spawn bis_fnc_dynamicText;
