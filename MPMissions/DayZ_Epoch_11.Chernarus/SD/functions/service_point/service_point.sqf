...
_coinsRefuelAir = 3000;
_coinsRefuelVehicles = 0;
 
_coinsRearmSUV = 10000;
_coinsRearmURAL = 80000;
_coinsRearmlynx = 80000;
_coinsRearmAir = 70000;
_coinsRearmATG = 80000;
_coinsRearmVehicles = 40000;
...
_folder = "SD\functions\service_point\"; // folder where the service point scripts are saved, relative to the mission file
...
_refuel_amount = 20; // amount of fuel to add with every update (in percent)
...
_rearm_costs = [
		...
		["Ural_ZU23_TK_EP1",[CurrencyName, _coinsRearmURAL]],
		["AW159_Lynx_BAF",[CurrencyName, _coinsRearmlynx]],
		["BRDM2_ATGM_INS",[CurrencyName, _coinsRearmATG]],
