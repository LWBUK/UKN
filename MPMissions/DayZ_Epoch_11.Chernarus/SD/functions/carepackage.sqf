...
_itemUse = "ItemAmethyst";// type of item
...
_LastUsedTime = 300; // time to use again
_downspeed = -2; //speed it falls down (hopefully) has to be negative
_boxtype = "USVehicleBox_EP1"; //type of box
_distance = 500; //distance before the box is deleted
_height = 100; //height it spawns in at

//item lists
_tools = ["ItemEtool","ItemKnife","ItemGPS","ItemFishingPole","ItemHatchet_DZE","ItemSledge","ItemCrowbar"];
_items = ["ItemSodaPepsi","FoodCanCorn","FoodNutmix","PipeBomb","ItemHotwireKit","ItemKiloHemp"];
_walls = ["ItemWoodWallGarageDoor","ItemWoodWallWithDoorLg","ItemWoodWallLg","cinder_wall_kit","cinder_garage_kit","metal_floor_kit"];
_supplies = ["CinderBlocks","MortarBucket","ItemTankTrap","PartWoodPlywood","PartWoodLumber","ItemPole","PartGlass"];

//weapon lists
_weapon = "BAF_AS50_scoped";
_weapon2 = "m107_DZ";
_weapon3 = "m107_DZ";
_weapon4 = "BAF_LRR_scoped";
_weapon5 = "BAF_LRR_scoped ";
_weapon6 = "M110_NVG_EP1";
...
_text = format ["\nYou need an Amethyst to call a carepackage!",_cost,10];
