...
if(isNil "DZE_CLICK_ACTIONS_BUILD") then {
    ...
    call compile preprocessFileLineNumbers "SD\ClickActions\config.sqf";
    player_selectSlot = compile preprocessFileLineNumbers "SD\ClickActions\ui_selectSlot.sqf";
