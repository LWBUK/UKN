...
MBT_CRATEDELAY = 300; //How long until the reward crate disappears (in seconds) Default: 900 (15 minutes)
MBT_DIALOG_TITLE = "EpochPack opening"; //Reward dialog title
MBT_DIALOG_CLAIM = "Claim Your Reward"; //Claim reward button
MBT_DIALOG_NOTE = "* After claiming your prize the reward crate will disappear in 5 minutes."; //Notation warning about the crate's delay
...
_rare_weapons_group = ["KSVK_DZE","MK_48_DZ","Pecheneg_DZ","M110_NVG_EP1","SCAR_H_LNG_Sniper_SD","M107_DZ","BAF_LRR_scoped","BAF_AS50_scoped_DZ","BAF_AS50_TWS","M110_TWS_EP1"];
...
MBC_REWARDLIST = [
    ...
    ,["coins","Coins",25000,2,5]
    ,["coins","Coins",30000,2,4]
    ,["coins","Coins",50000,2,3]
