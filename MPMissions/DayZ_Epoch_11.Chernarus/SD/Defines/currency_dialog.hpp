class CurrencyPlayerDialog
{
	...
	class controlsBackground {
		class CurrencyTitleBackground:ZSC_RscText {
		...
		class CurrencyMainBackground:ZSC_RscText {
	...
	class Controls {
		...
		class CurrencyAmountEdit : ZSC_RscEdit {
		...
		class CurrencyTitleText : ZSC_RscTitle {
		...
		class CurrencyAddCashButton : ZSC_RscButtonMenu 
		{
			idc = -1;
			text = "Add cash";
		...
		class CurrencyAddBankButton : ZSC_RscButtonMenu 
		{
			idc = -1;
			text = "Add bank";
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
		...
		class CurrencyRemoveCashButton : ZSC_RscButtonMenu 
		{
			idc = -1;
			text = "Remove cash";
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
		...
		class CurrencyRemoveBankButton : ZSC_RscButtonMenu 
		{
			idc = -1;
			text = "Remove bank";
			colorBackground[] = {"(profilenamespace getvariable ['GUI_BCG_RGB_R',0.3843])", "(profilenamespace getvariable ['GUI_BCG_RGB_G',0.7019])", "(profilenamespace getvariable ['GUI_BCG_RGB_B',0.8862])", 0.5};
		...
		class CurrencyCloseButton : ZSC_RscButtonMenu {
			idc = -1;
			text = "Close";
