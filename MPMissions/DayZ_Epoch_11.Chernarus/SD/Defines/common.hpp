class Life_RscScrollBar
{
	...
	thumb = "SD\Defines\Gui\thumb_ca.paa";
	arrowEmpty = "SD\Defines\Gui\arrowEmpty_ca.paa";
	arrowFull = "SD\Defines\Gui\arrowFull_ca.paa";
	border = "SD\Defines\Gui\border_ca.paa";
	shadow = 0;
	scrollSpeed = 0.06;
	width = 0;
	height = 0;
...
class Life_RscTree {
	...
	expandedTexture = "SD\Defines\Gui\expandedTexture_ca.paa";
	hiddenTexture = "SD\Defines\Gui\hiddenTexture_ca.paa";
	rowHeight = 0.0439091;
	color[] = {1, 1, 1, 1};
...
class Life_RscShortcutButton {
	...
	animTextureDefault = "SD\Defines\Gui\normal_ca.paa";
	animTextureNormal = "SD\Defines\Gui\normal_ca.paa";
	animTextureDisabled = "SD\Defines\Gui\normal_ca.paa";
	animTextureOver = "SD\Defines\Gui\over_ca.paa";
	animTextureFocused = "SD\Defines\Gui\focus_ca.paa";
	animTexturePressed = "SD\Defines\Gui\down_ca.paa";
	periodFocus = 1.2;
	periodOver = 0.8;
	class HitZone
	{
...
class Life_RscShortcutButtonMain : Life_RscShortcutButton {
	...
	animTextureNormal = "SD\Defines\Gui\main\normal_ca.paa";
	animTextureDisabled = "SD\Defines\Gui\main\disabled_ca.paa";
	animTextureOver = "SD\Defines\Gui\main\over_ca.paa";
	animTextureFocused = "SD\Defines\Gui\main\focus_ca.paa";
	animTexturePressed = "SD\Defines\Gui\main\down_ca.paa";
	animTextureDefault = "SD\Defines\Gui\main\normal_ca.paa";
	period = 0.5;
	font = "Zeppelin32";
...
class life_RscXSliderH 
{
	...
	arrowEmpty = "SD\Defines\Gui\slider\arrowEmpty_ca.paa";
	arrowFull = "SD\Defines\Gui\slider\arrowFull_ca.paa";
	border = "SD\Defines\Gui\slider\border_ca.paa";
	thumb = "SD\Defines\Gui\slider\thumb_ca.paa";
};
...
class Life_RscHTML {
	...
	sizeEx = "(((((safezoneW / safezoneH) min 1.2) / 1.2) / 25) * 1)";
	prevPage = "SD\Defines\Gui\arrow_left_ca.paa";
	nextPage = "SD\Defines\Gui\arrow_right_ca.paa";
	shadow = 2;
	class H1 {
		font = "Zeppelin32";
		fontBold = "Zeppelin32";
...
class Life_RscCombo {
	...
	arrowFull = "SD\Defines\Gui\arrowFull_sca.paa";
	arrowEmpty = "SD\Defines\Gui\arrowEmpty_ca.paa";
	wholeHeight = 0.45;
	color[] = {1, 1, 1, 1};
	colorActive[] = {1, 0, 0, 1};
