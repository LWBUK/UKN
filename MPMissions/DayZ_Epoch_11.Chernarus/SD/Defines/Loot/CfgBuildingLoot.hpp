...
class CfgBuildingLoot {
	...
	class Residential: Default {
		...
		lootType[] = {
			...
			{ "assaultrifles", "cfglootweapon", 0.03 }
		};
		lootTypeSmall[] = {
	...
	class Office: Default {
		...
		lootType[] = {
			...
			{ "assaultrifles", "cfglootweapon", 0.04 }
		};
		lootTypeSmall[] = {
			{ "ItemSodaMdew","magazine",0.01 },
			{ "ItemSodaRbull","magazine",0.01 },
	...
	class HeliCrash: Default {
		...
		lootType[] = {
			...
			{ "20Rnd_762x51_DMR", "magazine", 0.1 }, 
			{"Binocular_Vector", "weapon", 0.01 }, 
			{"M107_DZ", "weapon", 0.005 }, 
			{"M110_NVG_EP1", "weapon", 0.01 }, 
			{"DMR", "weapon", 0.05 }, 
			{"M14_EP1", "weapon", 0.05 }, 
			{"M24", "weapon", 0.09 }, 
			{"SCAR_L_STD_HOLO", "weapon", 0.09 }, 
			{"SCAR_L_CQC_EGLM_Holo", "weapon", 0.09 }, 
			{"SCAR_L_STD_EGLM_RCO", "weapon", 0.05 }, 
	...
	class MilitarySpecial: Default {
		...
		lootType[] = {
			...
			{"militarybackpacks","militarybackpacks",0.09},
			{"","medical",0.08},
			{"","generic",0.2},
			{"","military",0.1},
			{"machinegunammo","machinegunammo",0.08},
