private ["_passArray","_cancel","_position","_reason","_classnametmp","_classname","_tmpbuilt","_dir","_location","_text","_limit","_isOk","_proceed","_counter","_dis","_sfx","_started","_finished","_animState","_isMedic","_num_removed","_lockable","_combinationDisplay","_combination_1","_combination_2","_combination_3","_combination_4","_combination","_combination_1_Display","_playerUID","_OwnerUID","_vector","_buildOffset","_vUp","_posrad","_cntrad","_cntrad2"];
...
if (_cntrad > 0) then {
_cancel = true;
_reason = format["- Building is restricted %1m near military areas and trader zones", ServerIllegalRadius];
};
if (_cntrad2 > 0) then {
_cancel = true;
_reason = format["- Building is restricted %1m near bank zones", ServerIllegalRadius2];
};
