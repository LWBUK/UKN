call compile preprocessFileLineNumbers "SD\actions\Suicide\config.sqf";
...
{DZE_CLICK_ACTIONS set [count DZE_CLICK_ACTIONS,[_x,"Commit Suicide",format["'%1' execVM 'SD\actions\Suicide\suicide.sqf';",_x],"true"]];} forEach DZE_SUICIDE_WEAPONS;